    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            MessageBox.Show("Rules: " +
                "Player one is first to play, " +
                "Please play with two players! Have a good Game :D ");
        ...
        public class Global
        {
            ...
            public static int player1_wins = 0, player2_wins = 0, draw = 0, rounds = 0, p1 = 0, 
        ...
        {
            // Verify player one wins represented by "X" on the horizontal:
            ...
            // Verify player one wins represented by "X" on the vertical:
            ...
            // Verify Player one wins Represented by "X" on the diagonals:
            ...
            // Verify player two wins represented by "O" on the horizontal:
            ...
            // Verify player two wins represented by "O" on the vertical:
            ...
            // Verify Player two wins Represented by "O" on the diagonals:
            ...
            {
                Global.draw++;
                label6.Text = Convert.ToString(Global.draw);
